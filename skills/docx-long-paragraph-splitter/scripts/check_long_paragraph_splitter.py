...
CONFIG = {
  ...
  "display": "DOCX Long Paragraph Splitter",
  "short": "Flag overlong paragraphs.",
  "prompt": "Check this DOCX for long paragraphs that combine setup, result, and interpretation.",
  "desc": "Use when checking DOCX manuscripts for overlong paragraphs that should be split for reviewer readability.",
  "mode_desc": "long paragraphs that combine setup, result, interpretation, or method explanation.",
  "mode": "comments",
  "comment_rules": [
    {
      "min_words": 170,
      "message": "This paragraph combines too much material; please split setup, result, interpretation, and mechanism into separate sentences or paragraphs."
    }
  ],
  "script": "check_long_paragraph_splitter.py",
  "description": "Use when checking DOCX manuscripts for overlong paragraphs that should be split for reviewer readability.",
  "display_name": "DOCX Long Paragraph Splitter"
}
