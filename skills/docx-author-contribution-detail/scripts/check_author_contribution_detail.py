...
CONFIG = {
  ...
  "display": "DOCX Author Contribution Detail",
  "short": "Check author contribution detail.",
  "prompt": "Check this DOCX for overly generic author contribution statements.",
  "desc": "Use when checking DOCX author contribution statements for generic wording that needs named responsibilities.",
  "mode_desc": "generic author contribution statements that need named responsibilities.",
  "mode": "comments",
  "comment_rules": [
    {
      "any_contains": [
      ...
      "message": "Please expand the author contribution statement with named responsibilities before sharing with coauthors."
    }
  ],
  "script": "check_author_contribution_detail.py",
  "description": "Use when checking DOCX author contribution statements for generic wording that needs named responsibilities.",
  "display_name": "DOCX Author Contribution Detail"
}
