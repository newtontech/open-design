...
CONFIG = {
  ...
  "display": "DOCX First Use Definition Review",
  "short": "Find undefined first uses.",
  "prompt": "Check this DOCX for terms or abbreviations that need a full name and brief explanation at first use.",
  "desc": "Use when checking DOCX manuscripts for first-use definitions and brief explanations of technical abbreviations.",
  "mode_desc": "first-use definitions and brief explanations for manuscript-specific abbreviations.",
  "mode": "comments",
  "comment_rules": [
    {
      "any_contains": [
      ...
      "message": "Please give the full name and a brief explanation at first substantive use, then use the abbreviation consistently."
    }
  ],
  "script": "check_first_use_definition_review.py",
