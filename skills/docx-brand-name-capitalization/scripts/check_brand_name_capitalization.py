...
CONFIG = {
  ...
  "display": "DOCX Brand Name Capitalization",
  "short": "Fix official names in DOCX.",
  "prompt": "Check this DOCX for inconsistent database, supplier, software, and brand capitalization.",
  "desc": "Use when checking or fixing official database, supplier, software, and brand-name capitalization in DOCX files.",
  "mode_desc": "official capitalization for databases, suppliers, software, and brand names.",
  "mode": "replacements",
  "replacements": [
    {
      "old": "Pubchem",
      "new": "PubChem",
      "message": "Use official database capitalization."
    },
    {
      "old": "pubchem",
      "new": "PubChem",
    ...
    },
    {
      "old": "Sigma-aldrich",
      "new": "Sigma-Aldrich",
      "message": "Use official supplier capitalization."
    },
    {
      "old": "sigma-aldrich",
      "new": "Sigma-Aldrich",
    ...
    },
    {
      "old": "RDKIT",
      "new": "RDKit",
      "message": "Use official software capitalization."
    }
  ],
  "script": "check_brand_name_capitalization.py",
  "description": "Use when checking or fixing official database, supplier, software, and brand-name capitalization in DOCX files.",
  "display_name": "DOCX Brand Name Capitalization"
}
