...
CONFIG = {
  ...
  "display": "DOCX Formula Variable Definitions",
  "short": "Check formula variable definitions.",
  "prompt": "Check this DOCX for formula variables and loss terms that lack definitions.",
  "desc": "Use when checking DOCX equations and OfficeMath for undefined variables, loss terms, kernel symbols, and formula notation.",
  "mode_desc": "undefined variables and loss terms around equations and OfficeMath.",
  "mode": "comments",
  "comment_rules": [
    {
    ...
    {
      "regex": "Ri≔|R\\(X\\)|residual ΔPCE",
      "message": "Please define the residual target and explain how it differs from the baseline contribution."
    }
  ],
  "script": "check_formula_variable_definitions.py",
  ...
  "display_name": "DOCX Formula Variable Definitions"
}
