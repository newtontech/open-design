...
CONFIG = {
  ...
  "display": "DOCX Logic Bridge Review",
  "short": "Find weak reasoning bridges.",
  "prompt": "Check this DOCX for result-to-conclusion jumps that need a clearer reasoning bridge.",
  "desc": "Use when reviewing DOCX manuscripts for unclear reasoning from observed results to scientific conclusions.",
  "mode_desc": "result-to-conclusion jumps that need a clearer reasoning bridge.",
  "mode": "comments",
  "comment_rules": [
    {
      "any_contains": [
        "qualitative support",
        "demonstrates",
        "validated the two major clusters",
        "This observation indicates",
        "suggesting"
      ],
      "message": "Please add a clearer bridge from the observed result to the conclusion so reviewers can follow the scientific logic."
    }
  ],
  "script": "check_logic_bridge_review.py",
  "description": "Use when reviewing DOCX manuscripts for unclear reasoning from observed results to scientific conclusions.",
  "display_name": "DOCX Logic Bridge Review"
}
