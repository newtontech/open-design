...
CONFIG = {
  ...
  "display": "DOCX Compound Hyphenation",
  "short": "Fix compound modifiers.",
  "prompt": "Check this DOCX for missing hyphenation in compound modifiers and apply tracked changes.",
  "desc": "Use when checking or fixing DOCX compound modifier hyphenation such as molecule-specific or device-level.",
  "mode_desc": "compound modifier hyphenation and concatenated comparison phrases.",
  "mode": "replacements",
  "replacements": [
    {
      "old": "moleculespecific",
      "new": "molecule-specific",
      "message": "Hyphenate this compound modifier."
    },
    {
      "old": "devicelevel",
      "new": "device-level",
    ...
    {
      "old": "predictedversusexperimental",
      "new": "predicted-versus-experimental",
      "message": "Hyphenate the compound comparison phrase."
    },
    {
      "old": "candidate molecule treatment group",
      "new": "candidate-molecule-treated group",
      "message": "Hyphenate this treatment-group descriptor."
    }
  ],
  "script": "check_compound_hyphenation.py",
  "description": "Use when checking or fixing DOCX compound modifier hyphenation such as molecule-specific or device-level.",
  "display_name": "DOCX Compound Hyphenation"
}
