...
CONFIG = {
  ...
  "display": "DOCX Scientific Notation",
  "short": "Normalize scientific notation.",
  "prompt": "Check this DOCX for programming-style scientific notation and apply tracked changes.",
  "desc": "Use when checking or fixing DOCX scientific notation such as 8.5e-05 in academic manuscripts.",
  "mode_desc": "programming-style scientific notation in manuscript text.",
  "mode": "replacements",
  "regex_replacements": [
    {
      "pattern": "\\b\\d+(?:\\.\\d+)?e[+-]?\\d+\\b",
      "scientific": true,
      "message": "Use manuscript-style scientific notation instead of programming-style exponential notation."
    }
  ],
  "script": "check_scientific_notation.py",
  "description": "Use when checking or fixing DOCX scientific notation such as 8.5e-05 in academic manuscripts.",
  "display_name": "DOCX Scientific Notation"
}
