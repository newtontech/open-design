...
CONFIG = {
  ...
  "display": "DOCX Figure Caption Explanation",
  "short": "Check figure panel explanations.",
  "prompt": "Check this DOCX for figure captions that do not explain each panel clearly.",
  "desc": "Use when checking DOCX figure and supplementary figure captions for missing panel explanations.",
  "mode_desc": "figure captions that mention panels but do not explain each panel clearly.",
  "mode": "comments",
  "comment_rules": [
    {
      "scope": "caption",
      "regex": "\\b[a-h](?:\\s*[-–]\\s*[a-h])?,|\\([a-h]\\)",
      "message": "Please explain what each panel shows before discussing the interpretation."
    }
  ],
  "script": "check_figure_caption_explanation.py",
  "description": "Use when checking DOCX figure and supplementary figure captions for missing panel explanations.",
  "display_name": "DOCX Figure Caption Explanation"
}
