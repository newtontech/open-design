...
CONFIG = {
  ...
  "display": "DOCX Journal Structure Check",
  "short": "Check journal structure issues.",
  "prompt": "Check this DOCX for TOC, conclusion citations, and journal-style structure issues.",
  "desc": "Use when checking DOCX manuscripts for journal structure issues such as table of contents in the body or figure citations in conclusions.",
  "mode_desc": "journal-style structure issues such as body TOC and conclusion citations.",
  "mode": "comments",
  "comment_rules": [
    {
      "regex": "^Table of Contents$|^Contents$",
      "message": "Journal-style manuscript bodies typically do not include a table of contents; move it to cover-letter material if needed."
    },
    {
  ...
  "script": "check_journal_structure_check.py",
  ...
  "display_name": "DOCX Journal Structure Check"
}
