...
CONFIG = {
  ...
  "display": "DOCX Typographic Quotes",
  "short": "Normalize DOCX quotes.",
  "prompt": "Check this DOCX for inconsistent apostrophes and quotation marks.",
  "desc": "Use when checking or fixing DOCX apostrophes, smart quotes, duplicated quote marks, and quote consistency.",
  "mode_desc": "typographic apostrophes, smart quotes, and duplicated quotation marks.",
  "mode": "replacements",
  "replacements": [
    {
      "old": "model's",
      "new": "model’s",
      "message": "Use a typographic apostrophe consistently."
    },
    {
      "old": "additive's",
      "new": "additive’s",
    ...
    },
    {
      "old": "“\"",
      "new": "“",
      "message": "Remove duplicated quote marks."
    },
    {
      "old": "”\"",
      "new": "”",
