...
CONFIG = {
  ...
  "display": "DOCX Method Rationale Review",
  "short": "Find missing method rationale.",
  "prompt": "Check this DOCX for method choices, thresholds, baselines, or filtering steps that need rationale.",
  "desc": "Use when reviewing DOCX manuscripts for missing method rationale, threshold explanation, filtering justification, or baseline/residual motivation.",
  "mode_desc": "method choices, filtering thresholds, baselines, and inductive-bias rationale.",
  "mode": "comments",
  "comment_rules": [
    {
      "any_contains": [
        "multi-stage filtering protocol",
        "threshold",
        "baseline",
        "residual",
        "inductive bias"
      ],
      "message": "Please explain why this method, threshold, baseline, or decomposition is appropriate before relying on the result."
    }
  ],
  "script": "check_method_rationale_review.py",
  ...
  "display_name": "DOCX Method Rationale Review"
}
