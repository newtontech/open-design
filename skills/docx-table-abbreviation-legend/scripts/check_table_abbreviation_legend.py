...
CONFIG = {
  ...
  "display": "DOCX Table Abbreviation Legend",
  "short": "Find unexplained table abbreviations.",
  "prompt": "Check this DOCX for table or descriptor lists with unexplained abbreviations.",
  "desc": "Use when checking DOCX tables, descriptor lists, and feature lists for unexplained abbreviations that need a legend.",
  "mode_desc": "table or descriptor-list abbreviations that need a legend.",
  "mode": "comments",
  "comment_rules": [
    {
      "regex": "(?:[A-Z]{2,}[A-Za-z0-9_/+-]*,\\s*){4,}",
      "message": "Please define these abbreviations or provide a legend so reviewers can interpret the table or descriptor list."
    }
  ],
  "script": "check_table_abbreviation_legend.py",
  ...
  "display_name": "DOCX Table Abbreviation Legend"
}
